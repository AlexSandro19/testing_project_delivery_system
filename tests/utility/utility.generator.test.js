...
describe("Run tests for characterGenerator function", () => {
    ...
    test("Pass a valid number: 10, and expect a string with 9999 characters of following values: [a-z] OR [A-Z] OR [0-9]", () => {
        //Arrange
        const length = 11
        //Act
        const result = characterGenerator(length);
...
describe("Run tests for numberGenerator function", () => {
    ...
    test("Pass a valid number: 10, and expect a string with 9999 characters of following values: [0-9]", () => {
        //Arrange
        const length = 10
        //Act
        const result = numberGenerator(length);
