...
-- -----------------------------------------------------
-- Schema postnord_testing
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `postnord_testing` ;

-- -----------------------------------------------------
-- Schema postnord_testing
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `postnord_testing` DEFAULT CHARACTER SET utf8 ;
USE `postnord_testing` ;

-- -----------------------------------------------------
-- Table `postnord_testing`.`type_of_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `postnord_testing`.`type_of_user` ;

CREATE TABLE IF NOT EXISTS `postnord_testing`.`type_of_user` (
...
-- -----------------------------------------------------
-- Table `postnord_testing`.`zipcode`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `postnord_testing`.`zipcode` ;

CREATE TABLE IF NOT EXISTS `postnord_testing`.`zipcode` (
...
-- -----------------------------------------------------
-- Table `postnord_testing`.`country`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `postnord_testing`.`country` ;

CREATE TABLE IF NOT EXISTS `postnord_testing`.`country` (
...
-- -----------------------------------------------------
-- Table `postnord_testing`.`city`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `postnord_testing`.`city` ;

CREATE TABLE IF NOT EXISTS `postnord_testing`.`city` (
  ...
  CONSTRAINT `fk_city_country1`
    ...
    REFERENCES `postnord_testing`.`country` (`idcountry`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `postnord_testing`.`zip_city`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `postnord_testing`.`zip_city` ;

CREATE TABLE IF NOT EXISTS `postnord_testing`.`zip_city` (
  ...
  CONSTRAINT `fk_zip_city_zipcode1`
    ...
    REFERENCES `postnord_testing`.`zipcode` (`idzipcode`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_zip_city_city1`
    FOREIGN KEY (`city_idcity`)
    REFERENCES `postnord_testing`.`city` (`idcity`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `postnord_testing`.`user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `postnord_testing`.`user` ;

CREATE TABLE IF NOT EXISTS `postnord_testing`.`user` (
  ...
  CONSTRAINT `fk_customer_typeofreceiver_customer1`
    ...
    REFERENCES `postnord_testing`.`type_of_user` (`idtypeofuser`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_zip_city1`
    FOREIGN KEY (`zip_city_zipcode_idzipcode` , `zip_city_city_idcity`)
    REFERENCES `postnord_testing`.`zip_city` (`zipcode_idzipcode` , `city_idcity`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `postnord_testing`.`packages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `postnord_testing`.`packages` ;

CREATE TABLE IF NOT EXISTS `postnord_testing`.`packages` (
  ...
  CONSTRAINT `fk_packages_customer`
    ...
    REFERENCES `postnord_testing`.`user` (`idcustomer`)
    ON DELETE SET NULL
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `postnord_testing`.`typeofpayment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `postnord_testing`.`typeofpayment` ;

CREATE TABLE IF NOT EXISTS `postnord_testing`.`typeofpayment` (
...
-- -----------------------------------------------------
-- Table `postnord_testing`.`typeoflocation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `postnord_testing`.`typeoflocation` ;

CREATE TABLE IF NOT EXISTS `postnord_testing`.`typeoflocation` (
...
-- -----------------------------------------------------
-- Table `postnord_testing`.`location`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `postnord_testing`.`location` ;

CREATE TABLE IF NOT EXISTS `postnord_testing`.`location` (
  ...
  CONSTRAINT `fk_location_typeoflocation1`
    ...
    REFERENCES `postnord_testing`.`typeoflocation` (`idtypeoflocation`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `postnord_testing`.`payment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `postnord_testing`.`payment` ;

CREATE TABLE IF NOT EXISTS `postnord_testing`.`payment` (
  ...
  CONSTRAINT `fk_payment_typeofpayment1`
    ...
    REFERENCES `postnord_testing`.`typeofpayment` (`idtypeofpayment`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_payment_location1`
    FOREIGN KEY (`billing_address`)
    REFERENCES `postnord_testing`.`location` (`idlocation`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `postnord_testing`.`deliveries`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `postnord_testing`.`deliveries` ;

CREATE TABLE IF NOT EXISTS `postnord_testing`.`deliveries` (
  ...
  CONSTRAINT `fk_deliveries_packages1`
    ...
    REFERENCES `postnord_testing`.`packages` (`idpackages`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_deliveries_payment1`
    FOREIGN KEY (`payment_idpayment`)
    REFERENCES `postnord_testing`.`payment` (`idpayment`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
INSERT INTO user(type_of_user,firstname,secondname,companyname,email,phone,address,zip_city_city_idcity,zip_city_zipcode_idzipcode,duns,password) VALUES
